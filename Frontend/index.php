...
<head>
    ...
    <link rel="stylesheet" href="solid/dist/css/style.css">
            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
							<a class="logo_header" href="home.html">
			...
			<section class="cta section">
				<div class="container">
					<div class="cta-inner section-inner">
						<h3 class="section-title mt-0">Still not convinced to be a memeber?</h3>
						<div class="cta-cta">
        ...
        <footer class="site-footer">
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <div class="footer-copyright">&copy; 2021 FamJam4, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
